...
public class Db {
    ...
    public List<Integer> getMemberIdList() {
        ...
        Log.d("DB", "メンバーIDのレコード数:" + cursor.getCount());
    ...
    public List<String> getMemberNameList() {
        ...
        Log.d("DB", "メンバーの名前のレコード数:" + cursor.getCount());
    ...
    public List<Uri> getMemberImageList() {
        ...
        Log.d("DB", "メンバーの画像のレコード数:" + cursor.getCount());
...
//            );
    ...
    public List<String> getMemberStatusList() {
        ...
        Log.d("DB", "メンバーの在室状況のレコード数:" + cursor.getCount());
    ...
    public String getPersonDetail(
        ...
        Log.d("DB", "該当メンバーの詳細のレコード数:" + contentValue);
    ...
    public String getPersonCalender(
        ...
        // get total records value
        int contentValue = cursor.getCount();
        Log.d("DB", "該当メンバーのカレンダーのレコード数:" + contentValue);
    ...
    public String getPersonStatus(
        ...
        // get total records value
        int contentValue = cursor.getCount();
        Log.d("DB", "該当メンバーの在室状況のレコード数:" + contentValue);
    ...
    public String getPersonAddress(
        ...
        // get total records value
        int contentValue = cursor.getCount();
        Log.d("DB", "該当メンバーの連絡先のレコード数:" + contentValue);
