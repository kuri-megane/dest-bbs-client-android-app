...
public class PersonEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText editPersonDetail = findViewById(R.id.editTextPersonDetail);
        editPersonDetail.setText(personDetail);
        TextView textViewPersonCalender = findViewById(R.id.textViewTextCalenderId);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        TextView textViewCalenderId = findViewById(R.id.textViewTextCalenderId);
