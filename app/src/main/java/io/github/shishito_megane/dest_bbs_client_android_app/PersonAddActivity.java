...
public class PersonAddActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // calender id
        final Button buttonCreateNewCalender = findViewById(R.id.buttonCreateNewCalender);
        editTextCalenderId = findViewById(R.id.editTextCalenderId);
        textViewCalenderIdResult = findViewById(R.id.textViewCalenderIdResult);
        final EditText editPersonName = findViewById(R.id.editTextPersonName);
        ...
        // サムネイル選択
        final Button buttonSelectImage = findViewById(R.id.buttonSelectImage);
        imageViewPersonImage = findViewById(R.id.imageViewPersonImage);
        textViewPersonImageResult = findViewById(R.id.textViewPersonImageResult);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // get person info
        EditText editPersonName = findViewById(R.id.editTextPersonName);
        String personName = editPersonName.getText().toString();
        EditText editPersonAddress = findViewById(R.id.editTextPersonAddress);
        String personAddress = editPersonAddress.getText().toString();
        EditText editTextPersonDetail = findViewById(R.id.editTextPersonDetail);
        String personDetail = editTextPersonDetail.getText().toString();
        EditText editTextCalenderId = findViewById(R.id.editTextCalenderId);
